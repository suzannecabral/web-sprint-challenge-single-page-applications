...
It's used in place of a switch to match a section of a route to a given string. It's useful with more complex site structures with many links, like user pages.


1. How would you explain form validation to someone who has never programmed before?

Form validation is like spellchecking your work before you submit it. The program does it automatically and lets you know if there are any obvious errors, like an email without an @ symbol, or if any fields are missing.

1. In 1-2 sentences, define end to end testing.

End to end testing is the process of testing the user experience of each section of a website, step by step. This involves things like checking to make sure each input works, all the data exists and is visible on the page where it should be, and that forms and requests are submitted to and received from external servers correctly.
